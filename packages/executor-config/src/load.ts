// Vendored from RhysSullivan/executor@aa220d73bb3e567b96e8259ece7387d121ff4f3b:packages/core/config/src/load.ts
...
> =>
  Effect.gen(function* () {
    ...
    const decoded = yield* Schema.decodeUnknown(ExecutorFileConfig)(
      parsed,
    ).pipe(Effect.mapError((e) => new ConfigParseError(path, String(e))));
